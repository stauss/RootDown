...
<body>
	<!-- =========================== | PAGE | Wraps all content for res menu | =========================== -->
	<div id="page">
	...
	<header class="gHeader fullWrap">
		<section class="mid brandWrap">
			...
			<a href="#mNav" class="menuIcon"><i class="icon-align-justify"></i></a>
	...
	<div class="gWrap">
		...
		<!-- =========================== | CONTENT WRAP | Wraps all content after hero, creates mobile padding =========================== -->
		<div class="gToutPad">



			<!-- =========================== | GLOBAL TOUT WRAP | =========================== -->
			<section class="full gToutWrap">
...
<!-- =========================== | END PAGE | =========================== -->
	...
	<!-- Hammer is used for the mobile nav menu | this allows us to swipe the <body> and reveal the mobile nav -->
	...
	$(window).resize(function(){
		...
		if(winWidth <= 600) {
			...
			// get global nav and add id of mNav & enable mobile nav
		   	$('.gNav').attr('id', 'mNav');
		   	$('.gNav').removeClass('gNav');
	...
	$(document).ready(function(){
		...
		// !!!EDIT 
		//  Get the number of photos down to 14, Something with the count param????
