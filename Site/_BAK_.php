...
<body>
	...
	<a href="#mNav" class="menuIcon mOnly"><i class="icon-align-justify"></i></a>
		...
		if(winWidth <= 600) {
			...
			// get global nav and add id of mNav & enable mobile nav
		   	...
		   	$('nav#mNav').mmenu({
		   		...
		   		// Drag open functionality has issues on phones. Works unless you are scrolling  when menu opens
				//dragOpen: true
			}); 
